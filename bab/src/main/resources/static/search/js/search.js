...
//---------------------------------------------------------------//
//  모달창에서 #register_btn 클릭 시 submit + 등록 완료 알림창 띄우기
//---------------------------------------------------------------//
...
//---------------------------------------------------------------//
// $(function () {
//   $("div").slice(0, 1).show(); // 초기 개수
//   $("#load").click(function (e) {
//     // 클릭시 more
//     e.preventDefault();
//     $("div:hidden").slice(0, 1).show(); // 클릭시 more 개수 지저정
...
//---------------------------------------------------------------//
//    검색결과 더보기 버튼 클릭 시 리스트 5개씩 더 가져오기(naver local search api display 제한으로 구현 불가)
//---------------------------------------------------------------//
